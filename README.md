<div align= "center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #282d33;"> 👋 Hi there! I'm Eunjin Han<br></li>🖥️ I build apps that make everyday life easier <br></li><br></li></li>안녕하세요! 도전 속에서 배우고 끝까지 해내는 한은진입니다.<br></li>사용자와 가장 가까운 지점에서 도움을 줄 수 있는 앱을 만드는 것에 매력을 느끼고 있습니다. Flutter와 Swift를 기반으로 직접 서비스를 구현하며, 단순한 기능이 아니라 사용자의 흐름을 고려한 UI/UX를 설계하는 데 집중하고 있습니다. 팀 프로젝트에서는 역할을 나누고 함께 방향을 맞춰가는 과정을 즐기며, 문제를 해결해가는 과정 자체를 성장의 기회로 생각합니다.<br></li>앞으로도 끊임없이 배우고, 더 나은 사용자 경험을 만드는 개발자로 성장하고 싶습니다 🚀 </div> 
    </div>
    <div align= "center">
